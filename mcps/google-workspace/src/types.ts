...
tabId: z.string().optional().describe('The ID of the specific tab to apply styling in. If not specified, applies to the first tab (or legacy document.body for documents without tabs).'),
});
